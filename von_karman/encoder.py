...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 14 18:26:01 2021
...
## data path: 
path = '/Users/mac/Desktop/Koopman/von_karman/data/'
...
for e in range(epochs):
    for i in range(0, x.shape[0], batch_size):
        ...
        ## the reconstruction loss and the infinity norm loss: 
        loss = loss_fn(net_out, x_var) + 0.01*inf_norm(net_out,x_var)
        loss.backward()
        optimizer.step()
...
PATH = '/Users/mac/Desktop/Koopman/von_karman/models/encoder.h5'
